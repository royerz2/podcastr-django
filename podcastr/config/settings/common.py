# -*- coding: utf-8 -*-
"""
Django settings for podcastr project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (podcastr/config/settings/common.py - 3 = podcastr/)
APPS_DIR = ROOT_DIR.path('podcastr')
...
THIRD_PARTY_APPS = (
    ...
    'podcastr.taskapp.celery.CeleryConfig',  # celery
...
# -------------------------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'podcastr.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'podcastr.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'podcastr.users.adapters.SocialAccountAdapter'
...
# -------------------------------------------------------------------------------------------------
OCTOBAT_SUPPLIER_NAME = "podcastr.com"
