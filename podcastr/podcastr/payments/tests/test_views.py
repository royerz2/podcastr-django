...
class CheckoutViewTestCase(UserTestCase):
    ...
    @patch("podcastr.payments.views.sync_customer")
    @patch("podcastr.payments.views.StripeCustomer")
...
class PaymentMethodCreateViewTestCase(UserTestCase):
    ...
    @patch("podcastr.payments.views.delete_card")
    @patch("podcastr.payments.views.sync_payment_source_from_stripe_data")
    ...
    @patch("podcastr.payments.views.CustomPaymentMethodCreateView.create_card")
