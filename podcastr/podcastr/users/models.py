...
from podcastr.payments.plan import FreePlan, TrialPlan
from podcastr.payments.defaults import SAAS_SUBSCRIPTION_TYPE as DEFAULT_SAAS_SUBSCRIPTION_TYPE, SAAS_TRIAL_LENGTH as DEFAULT_SAAS_TRIAL_LENGTH
...
def subscribe_to_mailing_list(sender, instance=None, created=False, **kwargs):
    if created:
        from podcastr.users.tasks import subscribe_to_mailing_list
