...
from podcastr.payments.defaults import SAAS_SUBSCRIPTION_TYPE, SAAS_TRIAL_LENGTH
...
class TestUser(TestCase):
    ...
    def test_is_on_trial(self):
        ...
        with patch('podcastr.users.models.User.plan', new_callable=PropertyMock) as mocked_plan:
