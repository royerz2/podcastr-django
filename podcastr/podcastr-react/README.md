...
This will run all tests in the [`./podcastr/static/podcastr/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open podcastr/static/podcastr/dist//reports/coverage/lcov-report/index.html
...
#### Source `./podcastr/static/podcastr/`
Main project source.

#### Actions `./podcastr/static/podcastr/actions/`
...
#### Components `./podcastr/static/podcastr/components/`
React components. Mostly __dumb__ components.

#### Constants `./podcastr/static/podcastr/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./podcastr/static/podcastr/containers/`
...
[test-dir]: /podcastr/static/podcastr/__tests__/
